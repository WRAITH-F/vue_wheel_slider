...
! function(i, h, m, f, d, k, e) {
	...
	var c = {
		...
		g = i.$Jease$ = {
			...
			$InOutElastic: function(a) {
				...
				var b = .45,
					d = .1125;
				return (a *= 2) < 1 ? -.5 * c.v(2, 10 * (a -= 1)) * c.pb((a - d) * 2 * c.E / b) : c.v(2, -10 * (a -= 1)) * c.pb((a -
					d) * 2 * c.E / b) * .5 + 1
			},
			$InBack: function(a) {
				var b = 1.70158;
			...
			$InOutBack: function(a) {
				var b = 1.70158;
				return (a *= 2) < 1 ? 1 / 2 * a * a * (((b *= 1.525) + 1) * a - b) : 1 / 2 * ((a -= 2) * a * (((b *= 1.525) + 1) *
					a + b) + 2)
			},
			$InBounce: function(a) {
	...
	var b = i.$Jssor$ = new function() {
		...
		function D(a) {
			try {
				return G(a) == "object" && !a.nodeType && a != a.window && (!a.constructor || {}.hasOwnProperty.call(a.constructor
		...
		function N(c, a) {
			...
			if (a) {
				...
				if (H()) {
					if (a.$TranslateX || a.$TranslateY || a.$TranslateZ != e) b += " translate3d(" + (a.$TranslateX || 0) + "px," + (
						a.$TranslateY || 0) + "px," + (a.$TranslateZ || 0) + "px)";
		...
		j.Pg = function(d, a) {
			if (a) d.style.clip = "rect(" + c.$Round(a.$Top || a.N || 0) + "px " + c.$Round(a.$Right) + "px " + c.$Round(a.$Bottom) +
				"px " + c.$Round(a.$Left || a.K || 0) + "px)";
			else if (a !== e) {
				var h = d.style.cssText,
					g = [new RegExp(/[\s]*clip: rect\(.*?\)[;]?/i), new RegExp(/[\s]*cliptop: .*?[;]?/i), new RegExp(
						/[\s]*clipright: .*?[;]?/i), new RegExp(/[\s]*clipbottom: .*?[;]?/i), new RegExp(/[\s]*clipleft: .*?[;]?/i)],
					f = lb(h, g, "");
				b.xd(d, f)
			}
		};
		...
		function Ab(j, k, o) {
			...
			function m(b, c, f, g, i, l, n, o, q, t, u, w, y, A, C, F, a, d, e, h, j, k, m, p, r, s, v, x, z, B, D, E) {
				return [b * a + c * j + f * r + g * z, b * d + c * k + f * s + g * B, b * e + c * m + f * v + g * D, b * h + c * p +
					f * x + g * E, i * a + l * j + n * r + o * z, i * d + l * k + n * s + o * B, i * e + l * m + n * v + o * D, i *
					h + l * p + n * x + o * E, q * a + t * j + u * r + w * z, q * d + t * k + u * s + w * B, q * e + t * m + u * v +
					w * D, q * h + t * p + u * x + w * E, y * a + A * j + C * r + F * z, y * d + A * k + C * s + F * B, y * e + A *
					m + C * v + F * D, y * h + A * p + C * x + F * E
				]
			}
		...
		j.Ae = function(o, j, s, t, D, E, p) {
			...
			if (a.$Clip && !a.$Clip.$Top && !a.$Clip.$Left && !a.$Clip.N && !a.$Clip.K && a.$Clip.$Right == p.$OriginalWidth &&
				a.$Clip.$Bottom == p.$OriginalHeight) a.$Clip = f;
			return a
		}
	};
	...
	var n = {
		...
		s = i.$JssorSlideshowFormations$ = new function() {
			...
			h.$FormationStraight = function(f) {
				for (var d = f.$Cols, e = f.$Rows, s = f.$Assembly, t = f.sc, r = [], a = 0, b = 0, p = d - 1, q = e - 1, h = t -
						1, c, b = 0; b < e; b++)
					for (a = 0; a < d; a++) {
						switch (s) {
							case j:
			...
			h.$FormationRectangleCross = function(f) {
				for (var h = f.$Cols || 1, i = f.$Rows || 1, j = [], a, d = h / 2 - .5, e = i / 2 - .5, k = c.m(d, e) + 1, b = 0; b <
					h; b++)
	...
	var t = i.$JssorCaptionSlideo$ = function() {
			var a = this,
				hb = b.Y(a, o);
			l.call(a, 0, 0);
			var e, s, gb = [g.$Linear, g.$Swing, g.$InQuad, g.$OutQuad, g.$InOutQuad, g.$InCubic, g.$OutCubic, g.$InOutCubic, g.$InQuart,
					g.$OutQuart, g.$InOutQuart, g.$InQuint, g.$OutQuint, g.$InOutQuint, g.$InSine, g.$OutSine, g.$InOutSine, g.$InExpo,
					g.$OutExpo, g.$InOutExpo, g.$InCirc, g.$OutCirc, g.$InOutCirc, g.$InElastic, g.$OutElastic, g.$InOutElastic, g.$InBack,
					g.$OutBack, g.$InOutBack, g.$InBounce, g.$OutBounce, g.$InOutBounce, g.$Early, g.$Late
				],
				G = {},
				J, C, x = new l(0, 0),
				K = [],
			...
			a.B = function(i, f) {
				...
				b.c(c, function(a, d) {
					...
					if (c == "loading") R = a;
						...
						if (a.tagName != "STYLE" && a.tagName != "SCRIPT") nc[c || d] = new Rc(a, c == "slides", b.Dd(["slides",
							"thumbnavigator"
						])[c])
					}
				});
